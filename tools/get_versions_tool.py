...
class GetVersionsTool(MCPTool):
    name = "get_versions"
    description = "Get a list of versions from Redmine."
    arguments = [
        MCPToolArgument(
            name="redmine_url",
            type="string",
        ...
        MCPToolArgument(
            name="project_id",
            type="string",
            description="Project ID (if omitted, all versions)",
            required=False,
        ),
        MCPToolArgument(
            name="limit",
