...
def get_memberships(redmine_url: str, api_key: str, project_id: str, limit: int = None, offset: int = None):
    import os
...
GetMembershipsTool = Tool.from_function(
    get_memberships, name="get_memberships", description="Get a list of project memberships from Redmine."
)
