...
class GetTimeEntryActivitiesParams(BaseModel):
    """Params for get_time_entry_activities tool."""
...
async def get_time_entry_activities(
    ...
    Returns:
        Dict[str, Any]: A dictionary containing the list of time entry activities.
    """
    ...
    endpoint = f"{redmine_url}/enumerations/time_entry_activities.{format}"
